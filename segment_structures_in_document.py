...
def main():
    ...
    image
    """
    parser = argparse.ArgumentParser(description="Segment chemical structures from documents")
    ...
    try:
        ...
        normalized_segments = [get_square_image(segment, 299) for segment in raw_segments]
